...
import RequireAuth from "./RequireAuth"; // Importe o segurança que criamos
...
// 🚀 Envolvemos todos os elementos com o RequireAuth automaticamente
const protectedRoutesWithAuth = protectedRoutes.map(route => ({
  ...route,
  element: <RequireAuth>{route.element}</RequireAuth>
}));
export default protectedRoutesWithAuth;